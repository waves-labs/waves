...
contract PostDeploy is Script {
    function run(address worldAddress) external {
        ...
        //     vm.startBroadcast(deployerPrivateKey);
        //     new AccountProxy{salt: salt}(guardian, synthImplementation);
        //     vm.stopBroadcast();

        //     console.log("SynthProxy:", synthProxy, "(deployed)");
        // } else {
        //     console.log("SynthProxy:", synthProxy, "(exists)");
        // }

        // // Deploy Order Token
        // if (orderToken.code.length == 0) {
        //     vm.startBroadcast(deployerPrivateKey);
        //     new OrderToken{salt: salt}(worldAddress);
        //     vm.stopBroadcast();
        ...
        //     vm.startBroadcast(deployerPrivateKey);
        //     new WaveResolver{salt: salt}(EAS_OP, worldAddress);
        //     vm.stopBroadcast();
